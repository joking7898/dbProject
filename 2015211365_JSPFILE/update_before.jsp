...
<%
	...
	String user="ST2015211365"; 		  // 본인 아이디(ex.ST0000000000)
	String passwd="ST2015211365";   // 본인 패스워드(ex.ST0000000000)
...
<form method="post" action="update_verify.jsp">
  ...
  <table width="75%" align="center" border>
  	 <tr><th>이름</th>
         <td><input type="text" name="s_name" size="20"  value="<%= s_name %>"></td>
     </tr>
     <tr><th>주소</th>
	 ...
	 <tr><th>학부</th>
         <td><input type="text" name="s_college" size="20"  value="<%= s_college %>"></td>
     </tr>
	 <tr><th>전공</th>
         <td><input type="text" name="s_major" size="20"  value="<%= s_major %>"></td>
	 </tr>	   
<%
	}	
	stmt.close();  
